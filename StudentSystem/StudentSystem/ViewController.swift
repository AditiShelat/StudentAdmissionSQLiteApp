...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(btn)
        self.view.backgroundColor = UIColor(patternImage: UIImage(named: "img3.jpeg")!)
    }
...
//            UserDefaults.standard.setValue("Aditi", forKey: "uname")
