...
class AddStudentVC: UIViewController {
    ...
    func update(stud: Student){
        SQLiteHandler.shared.update(stud: stud){ success in
            if success{
                let alertController = UIAlertController(title: "Update Student", message: "updated successfully", preferredStyle: .alert)
    ...
    func insert(stud: Student){
        SQLiteHandler.shared.insert(stud:stud){ success in
            if success{
                let alertController = UIAlertController(title: "Insert Student", message: "inserted successfully", preferredStyle: .alert)
                let OKAction = UIAlertAction(title: "OK", style: .default) {
                    (action: UIAlertAction!) in
                    print("Ok button tapped");
                }
